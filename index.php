...
<title>TAKASHIMURA Catering | Classic Custom Cupcakes</title>
...
<div class="wrapper clr">
    <div class="header clr">
        <div class="main">
            <h1 class="logo">
                <a href="index.php">
                    <span>TAKASHIMURA Catering</span>
                </a>
            </h1>
            <div class="navtop">
        ...
        <div class="main">
            ...
            <div class="boxBottom last">
                ...
                <div class="inner" style="line-height:1.8;">
                    <div style="font-size:18px;">TAKASHIMURA</div>
                    <p>
    ...
    <div class="footer clr">
            &copy; 2014 TAKASHIMURA Catering, All right reserved.
        <div class="main">
        </div>
    </div><!--footer-->
